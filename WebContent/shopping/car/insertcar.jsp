...
<body>
    ...
    <div class="container" style="width: 100%;">
        <div class="title">중고 자동차 등록</div>
        <div class="row"><span class="item_title">제목</span><input type="text" name="select_title" style="width:900px"></div>
        <div class="row"><span class="item_title">상세설명</span><p><textarea name="select_description" cols="98" rows="10" style="resize: none;"></textarea></p></div>
        <script>
        </script>
    ...
    function selectModel(){
        ...
        var brandObj = event.srcElement;
        var brandList = null;
        if(brandObj.value=="현대"){
            brandList = hyundaicarlist;
        } else if(brandObj.value=="기아"){
            brandList = kiacarlist;
        } else if(brandObj.value=="제네시스"){
            brandList = genesiscarlist;
        } else if(brandObj.value=="쉐보레"){
            brandList = chevroletcarlist;
        } else if(brandObj.value=="르노삼성"){
            brandList = samsungcarlist;
        } else if(brandObj.value=="쌍용"){
    ...
    function selectArea(){
        ...
        var cityObj = event.srcElement;
        var cityList = null;
        if(cityObj.value=="서울"){
            cityList = seoul;
        } else if(cityObj.value=="경기"){
            cityList = kyunggi;
        } else if(cityObj.value=="인천"){
            cityList = incheon;
        } else if(cityObj.value=="대전"){
            cityList = daejeon;
        }  else if(cityObj.value=="충남"){
            cityList = choongnam;
        } else if(cityObj.value=="충북"){
            cityList = choongbook;
        } else if(cityObj.value=="강원"){
            cityList = kangwon;
        } else if(cityObj.value=="부산"){
            cityList = busan;
        } else if(cityObj.value=="대구"){
            cityList = daegu;
        } else if(cityObj.value=="울산"){
            cityList = ulsan;
        } else if(cityObj.value=="경남"){
            cityList = kyungnam;
        } else if(cityObj.value=="경북"){
            cityList = kyungbook;
        } else if(cityObj.value=="광주"){
            cityList = kwangju;
        } else if(cityObj.value=="전남"){
            cityList = jeonnam;
        } else if(cityObj.value=="전북"){
            cityList = jeonbook;
        } else if(cityObj.value=="제주"){
            cityList = jeju;
        } else {
            cityList=["선택"];
        }
    ...
    function dataCollect(form){
        ...
        for(var option of car_optionlist){
            if((option.seleced==true||option.checked==true)&&option.value!=null){
    ...
    function checkForm(carform) {
        ...
        carform.action = "insertcarpro.jsp"
        carform.method = "POST"
        carform.submit();
    }
    //===========================================================
