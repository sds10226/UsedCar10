...
int		maxSize		= 8*1024*1024;	//8메가 바이트
...
String car_idx = multireq.getParameter("car_idx");	
...
System.out.println(car_option+" / "+car_idx);

dao.updateCar(car_idx, car_img1, car_img2, car_img3, title, dealer_id, description, car_type, car_brand, car_model, car_cc, car_oilType, 
